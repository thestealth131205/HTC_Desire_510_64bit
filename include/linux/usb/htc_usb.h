...
static char *usb_functions_rndis_mtp_adb_acm[] = {
	"rndis",
	"mtp",
	"adb",
	"acm",
...
static char *usb_functions_ums_adb_diag_modem_rment[] = {
	"mass_storage",
	"adb",
	"diag",
	"modem",
...
static char *usb_functions_ums_diag_modem_rment[] = {
	"mass_storage",
	"diag",
	"modem",
#if defined(CONFIG_USB_ANDROID_MDM9K_DIAG)
...
static struct android_usb_product usb_products[] = {
	...
	{
		.product_id = 0x0f23,
		.num_functions	= ARRAY_SIZE(usb_functions_rndis_mtp_adb_acm),
		.functions	= usb_functions_rndis_mtp_adb_acm,
	},
	...
	{
		.product_id	= 0x0fd2,
		.num_functions	= ARRAY_SIZE(usb_functions_ums_adb_diag_modem_rment),
		.functions	= usb_functions_ums_adb_diag_modem_rment,
	},
	{
		.product_id	= 0x0fd3,
		.num_functions	= ARRAY_SIZE(usb_functions_ums_diag_modem_rment),
		.functions	= usb_functions_ums_diag_modem_rment,
	},
	{
		.product_id	= 0x0fd4,
...
static char *usb_inf_order_functions_diag_modem_rment[] = {
	"diag",
	"modem",
	"rmnet",
};

static char *usb_inf_order_functions_diag_modem_rment_adb[] = {
	"diag",
	"modem",
	"rmnet",
	"ffs",
...
static struct android_usb_product speical_usb_products_list[] = {
	{
		.vendor_id = 0x5c6,
		.product_id = 0x09092,
		.num_functions	= ARRAY_SIZE(usb_inf_order_functions_diag_modem_rment),
		.functions	= usb_inf_order_functions_diag_modem_rment,
	},
	{
		.vendor_id = 0x5c6,
		.product_id = 0x09091,
		.num_functions	= ARRAY_SIZE(usb_inf_order_functions_diag_modem_rment_adb),
		.functions	= usb_inf_order_functions_diag_modem_rment_adb,
	},
};
