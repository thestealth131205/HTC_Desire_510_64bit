...
#define YAS_TYPE_ACC_NONE		(0x00000001) 
#define YAS_TYPE_MAG_NONE		(0x00000002) 
#define YAS_TYPE_GYRO_NONE		(0x00000004) 
#define YAS_TYPE_A_ACC			(0x00000008) 
#define YAS_TYPE_M_MAG			(0x00000010) 
#define YAS_TYPE_G_GYRO			(0x00000020) 
...
struct yas_mag_calib_config {
	...
	uint16_t trad_variation[3]; 
	uint16_t cwg_threshold[12]; 
#endif
};
