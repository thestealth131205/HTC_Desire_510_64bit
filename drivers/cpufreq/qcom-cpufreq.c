...
#ifdef CONFIG_PERFLOCK
unsigned msm8916_perf_acpu_table[] = {
        533330000,  
        800000000,  
        998400000, 
        1094400000, 
...
static struct perflock_data msm8916_floor_data = {
        .perf_acpu_table = msm8916_perf_acpu_table,
        .table_size = ARRAY_SIZE(msm8916_perf_acpu_table),
};

static struct perflock_data msm8916_cpufreq_ceiling_data = {
        .perf_acpu_table = msm8916_perf_acpu_table,
        .table_size = ARRAY_SIZE(msm8916_perf_acpu_table),
};

static struct perflock_pdata perflock_pdata = {
        .perf_floor = &msm8916_floor_data,
        .perf_ceiling = &msm8916_cpufreq_ceiling_data,
};

struct platform_device msm8916_device_perf_lock = {
        .name = "perf_lock",
        .id = -1,
        .dev = {
