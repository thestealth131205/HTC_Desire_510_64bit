...
97b9a5d6ac4bea28fea79f2723a78764)
   ...
   V=5
;;
ba25a1bf2b52f3b0a72b0f93fffaafd2)
   # other_file = global_page_state(NR_FILE_PAGES) - global_page_state(NR_SHMEM) - global_page_state(NR_MLOCK);
   V=6
;;
fb792e719896ec288b54d67e02bd20cf)
