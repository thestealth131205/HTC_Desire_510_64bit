...
#define AUD_HW_NUM			9
#define HTC_AUDIO_TPA2051	0x001
#define HTC_AUDIO_TPA2026	0x002
#define HTC_AUDIO_TPA2028	0x004
#define HTC_AUDIO_A1028		0x008
#define HTC_AUDIO_TPA6185 	0x010
#define HTC_AUDIO_RT5501 	0x020
#define HTC_AUDIO_TFA9887 	0x040
#define HTC_AUDIO_TFA9887L 	0x080
